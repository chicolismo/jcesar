...
public class AdvancedBevelBorder extends AbstractBorder {
    private static final long serialVersionUID = -3504479640887740526L;

    private static final Color HIGHLIGHT = SystemColor.controlLtHighlight;
    ...
    public static AdvancedBevelBorder withDefaults() {
        return new AdvancedBevelBorder(HIGHLIGHT, SHADOW, SHADOW, HIGHLIGHT, null, 3);
    }
    ...
    public Insets getBorderInsets(Component c) {
        ...
        return new Insets(width, width, width + 1, width + 1);
    }
